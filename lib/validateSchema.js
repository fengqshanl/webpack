...
const validateSchema = (schema, options, validationConfiguration) => {
	// validate: Package for validate options in loaders and plugins. powered by webpack team
	// 通过编辑校验配置文件来检验对应的属性并反馈错误信息 -- https://www.npmjs.com/package/schema-utils?activeTab=readme
	validate(
		schema,
		options,
